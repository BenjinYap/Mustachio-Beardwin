		...
		public function Text(text:String, x:Number = 0, y:Number = 0, options:Object = null, h:Number = 0)
		{
			...
			if (options)
			{
				...
				else
				{
					...
					if (options.hasOwnProperty("shadow")) shadow = options.shadow;
					if (options.hasOwnProperty("shadowColor")) shadowColor = options.shadowColor;
			...
			if (shadow)
				_field.filters = [new DropShadowFilter (4, 45, shadowColor, 1, 0, 0, 1)];
			_field.sharpness = 0;
